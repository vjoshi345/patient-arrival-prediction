...
def run_model(sev='ESI 3'):
    ...
    split_time = 204  # this corresponds to using last 4 weeks for validation
    n_avg = 30  # take avg of last 30 weeks
    n_seasonality = 30  # 30 week seasonality for differencing
